...
pub const frontier: JumpTable = blk: {
    ...
    t[@intFromEnum(OpCode.CALLDATACOPY)] = .{ .execute_fn = instructions.opCallDataCopy, .constant_gas = gas_fast_step,    .dynamic_op = &dynamic_gas_and_memory, .min_stack = minStack(3, 0), .max_stack = maxStack(3, 0) };
    t[@intFromEnum(OpCode.CODESIZE)]     = .{ .execute_fn = instructions.opCodeSize, .constant_gas = gas_quick_step,   .min_stack = minStack(0, 1), .max_stack = maxStack(0, 1) };
    t[@intFromEnum(OpCode.CODECOPY)]     = .{ .execute_fn = instructions.opCodeCopy, .constant_gas = gas_fast_step,    .dynamic_op = &dynamic_gas_and_memory, .min_stack = minStack(3, 0), .max_stack = maxStack(3, 0) };
    t[@intFromEnum(OpCode.GASPRICE)]     = .{ .execute_fn = instructions.opGasprice, .constant_gas = gas_quick_step,   .min_stack = minStack(0, 1), .max_stack = maxStack(0, 1) };
    t[@intFromEnum(OpCode.EXTCODESIZE)]  = .{ .execute_fn = instructions.opExtCodeSize, .constant_gas = gas_slow_step,    .min_stack = minStack(1, 1), .max_stack = maxStack(1, 1) };
    t[@intFromEnum(OpCode.EXTCODECOPY)]  = .{ .execute_fn = instructions.opExtCodeCopy, .constant_gas = gas_fast_step,    .dynamic_op = &dynamic_gas_and_memory, .min_stack = minStack(4, 0), .max_stack = maxStack(4, 0) };

    t[@intFromEnum(OpCode.BLOCKHASH)]  = .{ .execute_fn = instructions.opBlockhash, .constant_gas = gas_ext_step,   .min_stack = minStack(1, 1), .max_stack = maxStack(1, 1) };
    ...
    t[@intFromEnum(OpCode.MSTORE8)] = .{ .execute_fn = instructions.opMstore8, .constant_gas = gas_fastest_step, .dynamic_op = &dynamic_gas_and_memory, .min_stack = minStack(2, 0), .max_stack = maxStack(2, 0) };
    t[@intFromEnum(OpCode.SLOAD)]   = .{ .execute_fn = instructions.opSload, .constant_gas = gas_slow_step,    .min_stack = minStack(1, 1), .max_stack = maxStack(1, 1) };
    t[@intFromEnum(OpCode.SSTORE)]  = .{ .execute_fn = instructions.opSstore, .constant_gas = 0,                .dynamic_op = &dynamic_gas_only,       .min_stack = minStack(2, 0), .max_stack = maxStack(2, 0) };
    t[@intFromEnum(OpCode.JUMP)]    = .{ .execute_fn = instructions.opJump, .constant_gas = gas_mid_step,     .min_stack = minStack(1, 0), .max_stack = maxStack(1, 0) };
    t[@intFromEnum(OpCode.JUMPI)]   = .{ .execute_fn = instructions.opJumpi, .constant_gas = gas_slow_step,    .min_stack = minStack(2, 0), .max_stack = maxStack(2, 0) };
...
pub const byzantium: JumpTable = blk: {
    ...
    t.table[@intFromEnum(OpCode.RETURNDATASIZE)] = .{
        .execute_fn   = instructions.opReturnDataSize,
...
pub const cancun: JumpTable = blk: {
    var t = shanghai;
    t.table[@intFromEnum(OpCode.TLOAD)]       = .{ .execute_fn = instructions.opTload, .constant_gas = gas_fast_step,    .min_stack = minStack(1, 1), .max_stack = maxStack(1, 1) };
    t.table[@intFromEnum(OpCode.TSTORE)]      = .{ .execute_fn = instructions.opTstore, .constant_gas = gas_fast_step,    .min_stack = minStack(2, 0), .max_stack = maxStack(2, 0) };
    ...
    t.table[@intFromEnum(OpCode.MCOPY)]       = .{ .execute_fn = instructions.opMcopy, .constant_gas = gas_fastest_step, .dynamic_op = &dynamic_gas_and_memory, .min_stack = minStack(3, 0), .max_stack = maxStack(3, 0) };
    break :blk t;
};
